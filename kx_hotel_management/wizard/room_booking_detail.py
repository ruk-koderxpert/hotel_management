...
class RoomBookingWizard(models.TransientModel):
    ...
    def action_room_booking_pdf(self):
        ...
        return self.env.ref("kx_hotel_management.action_report_room_booking").report_action(self, data=data)
    ...
    def generate_data(self):
        ...
        for rec in room_booking:
            rooms = (self.env["room.booking"].browse(rec["id"]).room_line_ids.room_id.mapped("name"))
